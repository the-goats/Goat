...
![David dependencies](https://badgen.net//david/dep/stefspakman/Goat/packages/task-modernizr?icon=libraries)
![David devdependencies](https://badgen.net//david/dev/stefspakman/Goat/packages/task-modernizr?icon=libraries)
