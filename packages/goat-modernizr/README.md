...
![David dependencies](https://badgen.net//david/dep/stefspakman/Goat/packages/goat-modernizr?icon=libraries)
![David devdependencies](https://badgen.net//david/dev/stefspakman/Goat/packages/goat-modernizr?icon=libraries)
