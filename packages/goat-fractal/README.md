...
![David dependencies](https://badgen.net//david/dep/stefspakman/Goat/packages/goat-fractal?icon=libraries)
![David devdependencies](https://badgen.net//david/dev/stefspakman/Goat/packages/goat-fractal?icon=libraries)
