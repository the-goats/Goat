...
![David dependencies](https://badgen.net//david/dep/stefspakman/Goat/packages/task-styles?icon=libraries)
![David devdependencies](https://badgen.net//david/dev/stefspakman/Goat/packages/task-styles?icon=libraries)
